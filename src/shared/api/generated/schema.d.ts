...
export interface paths {
    ...
    "/api/v1/student/tasks/{taskId}/submissions": {
        ...
        put?: never;
        /** Submit a TEXT answer or CODE solution for a homework task */
...
export interface components {
    schemas: {
        ...
        RunCodeResponse: {
            ...
            stdoutExcerpt?: string;
            stderrExcerpt?: string;
            tests?: components["schemas"]["RunCodeTestResponse"][];
        };
        /** @description Student-safe test result. Hidden tests never expose input or expected output. */
        RunCodeTestResponse: {
            passed?: boolean;
            hidden?: boolean;
            input?: string;
...
export interface operations {
    ...
    submitTextAnswer: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SubmitStudentSubmissionRequest"];
            };
        };
        responses: {
            /** @description Submission created and, for CODE, executed */
            201: {
                headers: {
                    [name: string]: unknown;
                };
