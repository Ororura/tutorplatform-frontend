  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <div className="flex items-start justify-between gap-6">
        ...
        <div className="flex items-center gap-3"><Link className="inline-flex h-10 items-center rounded-md border border-neutral-300 px-4 text-sm font-medium" href="/teacher/tasks">Банк заданий</Link><LogoutButton /></div>
      </div>
