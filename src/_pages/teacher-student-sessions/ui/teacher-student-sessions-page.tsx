...
export async function TeacherStudentSessionsPage({ params }: Readonly<{ params: Promise<{ studentId: string }> }>) {
  ...
  return <Suspense fallback={<p className="mx-auto max-w-5xl px-6 py-12" aria-busy="true">Загружаем занятия…</p>}><TeacherStudentSessionsView studentId={studentId} /></Suspense>;
}
