    ...
    <main className="mx-auto max-w-5xl space-y-8 px-6 py-12">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
          ...
          {programs.data && programs.data.length > 0 && (
            <Link
              ...
              href={`/teacher/students/${studentId}/sessions/new`}
            >
              Добавить занятие
            </Link>
          )}
      ...
      {sessions.isError && (
        <div className="space-y-3 rounded-lg border border-red-200 bg-red-50 p-5" role="alert">
          <p>Не удалось загрузить занятия.</p>
        ...
        <div className="space-y-4 rounded-lg border border-dashed border-neutral-300 p-8 text-center">
          ...
          {programs.data && programs.data.length > 0 ? (
            ...
            <>
              ...
              <Link className="underline underline-offset-4" href={`/teacher/students/${studentId}/program`}>
      ...
      {sessions.data && sessions.data.totalPages > 1 && (
        <nav className="flex items-center justify-between" aria-label="Пагинация занятий">
          <button
