...
async function createStudentInvite(studentId: string, body: CreateStudentInviteRequest): Promise<CreatedStudentInvite> {
  const { data, error, response } = await apiClient.POST("/api/v1/teacher/students/{studentId}/invites", {
