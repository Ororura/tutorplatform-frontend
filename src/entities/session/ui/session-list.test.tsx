...
const base = { studentProgramId: "program-1", startedAt: "2026-09-14T13:30:00Z", durationMinutes: 60, summary: "Разобрали переменные", topics: [{ topicId: "topic-1", isPrimary: true }], createdAt: "2026-09-14T13:30:00Z", updatedAt: "2026-09-14T13:30:00Z", version: 0 };

describe("SessionList", () => {
  it("renders all attendance states, summary, duration and a detail link", () => {
    render(<SessionList studentId="student-1" sessions={[
